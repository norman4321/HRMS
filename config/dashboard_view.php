...
function DashboardList(){
    ...
    $sql = "SELECT room_number,type_name,status_description FROM hrms_room INNER JOIN hrms_room_type ON room_type=type_id  INNER JOIN hrms_room_status ON room_status=status_id ORDER BY room_number";
