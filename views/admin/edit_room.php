                ...
                <div class="add-room">
                    ...
                    <form action="#">
                        <div class="input-box">
                            ...
                            <input id="RoomNumber" name="room_number" type="text" placeholder="Room Number" disabled>
                        </div>
                        <div class="add-details">
                            <div class="input-box">
                                <span class="form-details">Room Name: </span>
                                <input type="text" name="room_name" placeholder="Room Name" maxlength="50" required>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                <span class="form-details">Room Size: </span>
                                <input type="text" name="room_size" placeholder="Size" maxlength="256" required>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                <span class="form-details">Price/Rate: </span>
                                <input type="text" name="room_price" placeholder="Price/Rate" required>
                            </div>
                            <div class="input-box-area">
                                <span class="form-details">Amenities: </span>
                                <textarea name="roomDesc" name="room_amenities" placeholder="Amenities" required maxlength="500"></textarea>
                            </div>
                            <div class="input-box-area">
